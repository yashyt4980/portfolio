  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        I'm a third-year BTech student deeply entrenched in the MERN stack. My journey has been a dynamic fusion of theoretical learning and hands-on experience.
        </p>
